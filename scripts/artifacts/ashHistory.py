...
def get_ash_history(files_found, report_folder, seeker, wrap_text):
    ...
    for file_found in files_found:
        ...
        if usageentries > 0:
            ...
            tsvname = f'ash_history_{user_name}'
            tsv(report_folder, data_headers, data_list, tsvname)
            
        else:
            logfunc(f'No ASH history data for {user_name}available')
...
# ToDo, replace user name with the directory it was found in
